...
export async function catalogPage(response,env,url){
 ...
 if(!['/','/services','/request'].includes(path)&&!path.startsWith('/services/'))return response;
 ...
 if(path.startsWith('/services/')){
  ...
  html=html.replace(/(<link rel="alternate" hreflang="en" href=")[^"]+/,`$1https://www.nathonline.com.np/services/${id}`).replace(/(<link rel="alternate" hreflang="ne" href=")[^"]+/,`$1https://www.nathonline.com.np/ne/services/${id}`);status=200;
 }else{
